    ...
    methods: {
        ...
        Refresh() {
            if (this.timeSlot === null) {
                ...
                console.log(data);
                var ipaddress = "http://" + this.ipAddress + ":" + this.ipPort + "/api/Alarm/GetHistoricalAlarm";
               // var ipaddress = "http://192.168.1.107:8090/api/Alarm/GetHistoricalAlarm";
        ...
        Export() {
            if (this.timeSlot === null) {
                ...
                var ipaddress = "http://" + this.ipAddress + ":" + this.ipPort + "/api/Alarm/ExportExcelHistoricalAlarm";
                data = JSON.stringify(JSON.stringify(data));
                axios.post(
                    ipaddress,
                    data,
        ...
        openKnowledgeBaseClick(res) {
            ...
            this.AlarmDesc = res.description;
            this.AlarmPriority = res.priority;
            var data = {
                AlarmDescription: res.description,
            }
        ...
        onSubmit() {
            ...
            var ipaddress = "http://" + this.ipAddress + ":" + this.ipPort + "/api/Alarm/GetHistoricalAlarmKPI";
            data = JSON.stringify(JSON.stringify(data));
            var that = this;
            axios.post(
                ipaddress,
