(function (window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        rowDoubleClick: $.noop,
        cellDoubleClick: $.noop,
        noDataContent: "",//yantao
        ...
        loadIndication: false,//yantao
        loadIndicationDelay: 500,
        loadMessage: "Please, wait...",
        loadShading: false,//Yantao
        ...
        //yantao add
        _createHeader1: function () {
            var $headerRow1 = this._headerRow1 = this._createHeaderRow();

            var $headerGrid1 = this._headerGrid1 = $("<table>").addClass(this.tableClass)
                .append($headerRow1);

            var $header1 = this._header1 = $("<div>").addClass(this.gridHeaderClass)
                //.addClass(this._scrollBarWidth() ? "jsgrid-header-scrollbar" : "")
                .append($headerGrid1);
        ...
        _createRow: function (item, itemIndex) {
            ...
            $result.addClass(this._getRowClasses(item, itemIndex))
                ...
                .find("td").on("dblclick", $.proxy(function (e) {
        ...
        openPage: function (pageIndex) {
            ...
            this._callEventHandler(this.afterPageChanged, {
                pageIndex: pageIndex
            });
        },
