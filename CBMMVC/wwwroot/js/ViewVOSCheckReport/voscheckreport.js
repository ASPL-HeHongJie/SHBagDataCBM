    ...
    methods: {
        ...
        Refresh() {
            ...
            if (this.timeSlot == '') {
                ...
                this.timeSlot.map((res, index) => {
                    ...
                    console.log(data)
                    var ipaddress = "http://" + this.ipAddress + ":" + this.ipPort + "/api/CheckData/GetHistoricalVOSCheckReport";
        ...
        handleClick(res) {
            ...
            setTimeout(() => {
                ...
                $("#report").attr('src', 'http://' + this.reportServerIpAndPort + '/VOSReportForm.aspx?ID=' + this.hisID + '&ManufacturerName=' + this.brandName + '&Address=' + this.reportIPAddress);
            }, 0)
        }
    }
})