    ...
    methods: {
        ...
        Refresh() {
            ...
            if (this.timeSlot == '') {
                ...
                var ipaddress = "http://" + this.ipAddress + ":" + this.ipPort + "/api/CheckData/GetHistoricalLoopCheckReport";
        ...
        handleClick(res) {
            ...
            setTimeout(() => {
                ...
                $("#report").attr('src', 'http://' + this.reportServerIpAndPort +'/LoopReportForm.aspx?ID=' + this.hisID + '&ManufacturerName=' + this.brandName + '&Address=' + this.reportIPAddress);
            }, 0);
        }
    }
})
