    ...
    methods: {
        ...
        Refresh() {
            ...
            if (this.AnalyzerName == '') {
                ...
                if (data.EquipmentID == '' && data.BrandName == '') {
                    ...
                    this.loading = true;
                    var ipaddress = "/api/CheckData/GetHistoricalGCCheckReport";
        ...
        handleClick(res) {
            ...
            setTimeout(() => {
                ...
                $("#report").attr('src', 'http://' + this.reportServerIpAndPort +'/GCReportForm.aspx?ID=' + this.hisID + '&ManufacturerName=' + this.brandName + '&Address=' + reportIPAddress);
            }, 0);
        }
    }
})
