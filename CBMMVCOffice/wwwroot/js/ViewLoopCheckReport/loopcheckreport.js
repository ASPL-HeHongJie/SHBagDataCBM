    ...
    methods: {
        ...
        Refresh() {
            ...
            if (this.timeSlot == '') {
                ...
                var ipaddress = "/api/CheckData/GetHistoricalLoopCheckReport";
        ...
        handleClick(res) {
            ...
            setTimeout(() => {
                ...
                $("#report").attr('src', 'http://' + this.reportServerIpAndPort + '/LoopReportForm.aspx?ID=' + this.hisID + '&ManufacturerName=' + this.brandName + '&Address=' + reportIPAddress);
            }, 0);
        }
    }
})
