var vm = new Vue({
    ...
    methods: {
        ...
        getEarlyWarningCharts(tab, event) {
            ...
            var ipaddress = "http://" + this.station.IPAddress + ":" + this.station.IPPort + "/api/Trend/GetEarlyWarningTrend";
            var data = {
                LoopID: tab.loopID,
                ConfigureConditionID: tab.configureConditionID,
            }
            console.log(data);
            axios.post(
                ipaddress,
                ...
                .then((res) => {
                    ...
                    this.EarlyWarningTrendTimesData = res.data.Times;
                    this.EarlyWarningTrendData = res.data.Trends[0];
                    this.EarlyWarningTrendData.AlarmHighLimit = this.EarlyWarningTrendData.AlarmHighLimit == null ? 'null' : this.EarlyWarningTrendData.AlarmHighLimit;
                    this.EarlyWarningTrendData.AlarmLowLimit = this.EarlyWarningTrendData.AlarmLowLimit == null ? 'null' : this.EarlyWarningTrendData.AlarmLowLimit;
                    this.EarlyWarningTrendData.HighLimit = this.EarlyWarningTrendData.HighLimit == null ? 'null' : this.EarlyWarningTrendData.HighLimit;
                    this.EarlyWarningTrendData.LowLimit = this.EarlyWarningTrendData.LowLimit == null ? 'null' : this.EarlyWarningTrendData.LowLimit;
                    let maxVal = this.EarlyWarningTrendData.TrendMaxVal;
                    let minVal = this.EarlyWarningTrendData.TrendMinVal;
                    ...
                    let data = {
                        ...
                        xAxis: {
                            ...
                            data: this.EarlyWarningTrendTimesData
                        },
                        yAxis: {
                            type: 'value',
                            axisLabel: {
                        ...
                        series: [{
                            name: this.EarlyWarningTrendData.Description,
                            type: 'line',
                            data: this.EarlyWarningTrendData.TrendDatas,

                            markLine: {
                                data: [{
                                    name: '上报警线',
                                    yAxis: this.EarlyWarningTrendData.AlarmHighLimit.toString(),
                                    label: {
                                        formatter: '报警上限',
                                        position: 'end',
                                        color: '#F00'
                                    ...
                                    name: '上预警线',
                                    yAxis: this.EarlyWarningTrendData.HighLimit.toString(),
                                    label: {
                                        formatter: '预警上限',
                                        position: 'end',
                                        color: '#FF9500'
                                    ...
                                    name: '下报警线',
                                    yAxis: this.EarlyWarningTrendData.AlarmLowLimit.toString(),
                                    label: {
                                        formatter: '报警下限',
                                        position: 'end',
                                        color: '#F00'
                                    ...
                                    name: '下预警线',
                                    yAxis: this.EarlyWarningTrendData.LowLimit.toString(),
                                    label: {
                                        formatter: '预警下限',
                                        position: 'end',
                                        color: '#FF9500'
