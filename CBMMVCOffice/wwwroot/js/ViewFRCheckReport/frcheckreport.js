    ...
    methods: {
        ...
        Refresh() {
            ...
            if (this.timeSlot == '') {
                ...
                console.log(data)
                var ipaddress = "/api/CheckData/GetHistoricalFlowrateCheckReport";
        ...
        handleClick(res) {
            ...
            setTimeout(() => {
                ...
                $("#report").attr('src', 'http://' + this.reportServerIpAndPort+'/FRReportForm.aspx?ID=' + this.hisID + '&ManufacturerName=' + this.brandName + '&Address=' + reportIPAddress);
            }, 0);
        }
    }
})
