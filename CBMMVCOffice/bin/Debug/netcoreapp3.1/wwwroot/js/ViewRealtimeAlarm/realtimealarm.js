    ...
    methods: {
        ...
        Refresh() {
            ...
            if (this.AlarmTypeName == 'EquipmentAlarm') {
                ...
                var ipaddress = "/api/Alarm/GetRealtimeAlarm";
                ...
                var ipaddress = "/api/Alarm/GetRealtimeDiagnosticAlarm";
                //'http://192.168.1.103:8081/api/Alarm/GetRealtimeAlarm'
                data = JSON.stringify(JSON.stringify(data));
                var that = this;
                axios.post(
        ...
        Export() {
            ...
            if (this.AlarmTypeName == 'EquipmentAlarm') {
                ...
                console.log(data);
                var ipaddress = "/api/Alarm/ExportExcelRealtimeAlarm";
                data = JSON.stringify(JSON.stringify(data));
                console.log(data)
                ...
                console.log(data);
                var ipaddress = "/api/Alarm/ExportExcelRealtimeDiagnosticAlarm";
                data = JSON.stringify(JSON.stringify(data));
                console.log(data)
