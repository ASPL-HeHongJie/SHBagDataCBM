    ...
    methods: {
        ...
        Refresh() {
            ...
            if (this.timeSlot == '') {
                ...
                this.timeSlot.map((res, index) => {
                    ...
                    var ipaddress = "/api/CheckData/GetHistoricalVOSCheckReport";
        ...
        handleClick(res) {
            ...
            setTimeout(() => {
                ...
                $("#report").attr('src', 'http://' + this.reportServerIpAndPort + '/VOSReportForm.aspx?ID=' + this.hisID + '&ManufacturerName=' + this.brandName + '&Address=' + reportIPAddress);
            }, 0)
        }
    }
})